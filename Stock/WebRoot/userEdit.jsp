...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">用户管理&gt;&gt;<s:if test="#attr.user!=null && #attr.user.userId!=0">编辑</s:if><s:else>添加</s:else>用户</span>
</div>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
        ...
        <tr>
          ...
          <td>
            <s:textfield name="paramsUser.userCompany" id="paramsUser.userCompany" value="%{#attr.user.userCompany}"/>
          </td> 
          <td align="right" style="padding-right:5px">地址：</td>
          <td>
          	<s:textfield name="paramsUser.userAddress" id="paramsUser.userAddress" value="%{#attr.user.userAddress}"/>
          </td>
        </tr>
        <tr>
