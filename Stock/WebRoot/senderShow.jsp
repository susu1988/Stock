...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">配送员管理&gt;&gt;配送员查询</span>
</div>
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            用户名：
      <input type="text" id="paramsUser.userName" name="paramsUser.userName" value="${paramsUser.userName}" class="inputstyle"/>&nbsp;
            姓名：
      <input type="text" id="paramsUser.realName" name="paramsUser.realName" value="${paramsUser.realName}" class="inputstyle"/>&nbsp;&nbsp;
      <input type="button" value="搜索" onclick="serch();" class="btnstyle"/>&nbsp;
      <input type="button" value="增加" onclick="window.location='Admin_addSenderShow.action';" class="btnstyle"/>&nbsp;
